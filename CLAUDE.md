...
- Design tokens: base `#CBCBCB`, ink `#4A4A4A`, cream `#FFFFE3`, slate accent `#6D8196`. Neumorphic raised/pressed shadow pairs are defined once in `frontend-ui-agent.md` — don't hand-roll new shadow values elsewhere.
